...
if("FALSE" STREQUAL "TRUE")
  set(turtlesim_SOURCE_PREFIX /tmp/buildd/ros-groovy-turtlesim-0.3.13-0precise-20140305-1700)
  set(turtlesim_DEVEL_PREFIX /tmp/buildd/ros-groovy-turtlesim-0.3.13-0precise-20140305-1700/obj-x86_64-linux-gnu/devel)
  ...
  set(turtlesim_INSTALL_PREFIX /opt/ros/groovy)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'turtlesim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/groovy/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
set(depends "message_runtime;std_msgs;std_srvs")
